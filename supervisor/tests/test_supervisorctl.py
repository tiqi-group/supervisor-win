...
class TestDefaultControllerPlugin(unittest.TestCase):
    ...
    def test_status_all_processes_no_arg(self):
        ...
        self.assertEqual(value[0].split(None, 2), ["foo", "RUNNING", "foo description"])
        self.assertEqual(value[1].split(None, 2), ["bar", "FATAL", "bar description"])
        self.assertEqual(
            value[2].split(None, 2), ["baz:baz_01", "STOPPED", "baz description"]
        )
    ...
    def test_status_process_name(self):
        ...
        self.assertEqual(result, None)
        value = plugin.ctl.stdout.getvalue().strip()
        self.assertEqual(value.split(None, 2), ["foo", "RUNNING", "foo description"])
        self.assertEqual(plugin.ctl.exitstatus, LSBInitExitStatuses.SUCCESS)
    ...
    def test_status_group_name(self):
        ...
        value = plugin.ctl.stdout.getvalue().split("\n")
        self.assertEqual(
            value[0].split(None, 2), ["baz:baz_01", "STOPPED", "baz description"]
        )
        self.assertEqual(plugin.ctl.exitstatus, LSBStatusExitStatuses.NOT_RUNNING)
    ...
    def test_status_mixed_names(self):
        ...
        self.assertEqual(value[0].split(None, 2), ["foo", "RUNNING", "foo description"])
        self.assertEqual(
            value[1].split(None, 2), ["baz:baz_01", "STOPPED", "baz description"]
        )
        self.assertEqual(plugin.ctl.exitstatus, LSBStatusExitStatuses.NOT_RUNNING)
    ...
    def test_start_badname(self):
        ...
        self.assertEqual(result, None)
        self.assertEqual(
            plugin.ctl.stdout.getvalue(), "BAD_NAME: ERROR (no such process)\n"
        )
        self.assertEqual(plugin.ctl.exitstatus, LSBInitExitStatuses.GENERIC)
    ...
    def test_start_no_file(self):
        ...
        self.assertEqual(result, None)
        self.assertEqual(
            plugin.ctl.stdout.getvalue(), "NO_FILE: ERROR (no such file)\n"
        )
        self.assertEqual(plugin.ctl.exitstatus, LSBInitExitStatuses.GENERIC)
    ...
    def test_start_alreadystarted(self):
        ...
        self.assertEqual(result, None)
        self.assertEqual(
            plugin.ctl.stdout.getvalue(), "ALREADY_STARTED: ERROR (already started)\n"
        )
        self.assertEqual(plugin.ctl.exitstatus, LSBInitExitStatuses.SUCCESS)
    ...
    def test_start_spawnerror(self):
        ...
        self.assertEqual(result, None)
        self.assertEqual(
            plugin.ctl.stdout.getvalue(), "SPAWN_ERROR: ERROR (spawn error)\n"
        )
    ...
    def test_start_group_bad_name(self):
        ...
        self.assertEqual(result, None)
        self.assertEqual(
            plugin.ctl.stdout.getvalue(), "BAD_NAME: ERROR (no such group)\n"
        )
        self.assertEqual(plugin.ctl.exitstatus, LSBInitExitStatuses.INVALID_ARGS)
    ...
    def test_stop_fail(self):
        ...
        self.assertEqual(result, None)
        self.assertEqual(
            plugin.ctl.stdout.getvalue().split("\n")[0],
    ...
    def test_stop_notrunning(self):
        ...
        self.assertEqual(result, None)
        self.assertEqual(
            plugin.ctl.stdout.getvalue(), "NOT_RUNNING: ERROR (not running)\n"
        )
        self.assertEqual(plugin.ctl.exitstatus, LSBInitExitStatuses.SUCCESS)
    ...
    def test_stop_many(self):
        ...
        self.assertEqual(result, None)
        self.assertEqual(
            plugin.ctl.stdout.getvalue(), "foo: stopped\n" "bar: stopped\n"
        )
        self.assertEqual(plugin.ctl.exitstatus, LSBInitExitStatuses.SUCCESS)
    ...
    def test_signal_many(self):
        ...
        self.assertEqual(result, None)
        self.assertEqual(
            plugin.ctl.stdout.getvalue(), "foo: signalled\n" "bar: signalled\n"
        )
        self.assertEqual(plugin.ctl.exitstatus, LSBInitExitStatuses.SUCCESS)
    ...
    def test_open_fail(self):
        ...
        self.assertEqual(result, None)
        self.assertEqual(
            plugin.ctl.stdout.getvalue(), "ERROR: url must be http:// or unix://\n"
        )
        self.assertEqual(plugin.ctl.exitstatus, LSBInitExitStatuses.GENERIC)
    ...
    def test_reread_shutdown_state(self):
        ...
        plugin.do_reread(None)
        self.assertEqual(
            plugin.ctl.stdout.getvalue(), "ERROR: supervisor shutting down\n"
        )
        self.assertEqual(plugin.ctl.exitstatus, LSBInitExitStatuses.GENERIC)
    ...
    def test_add_already_added(self):
        ...
        self.assertEqual(result, None)
        self.assertEqual(
            plugin.ctl.stdout.getvalue(), "ERROR: process group already active\n"
        )
        self.assertEqual(plugin.ctl.exitstatus, LSBInitExitStatuses.SUCCESS)
    ...
    def test_add_bad_name(self):
        ...
        self.assertEqual(result, None)
        self.assertEqual(
            plugin.ctl.stdout.getvalue(), "ERROR: no such process/group: BAD_NAME\n"
        )
        self.assertEqual(plugin.ctl.exitstatus, LSBInitExitStatuses.GENERIC)
    ...
    def test_update_with_gname(self):
        ...
        self.assertEqual(
            sorted(supervisor.processes),
            sorted(["changed", "removed", "added1", "added2"]),
        )

        plugin.do_update("removed")
        self.assertEqual(
            sorted(supervisor.processes), sorted(["changed", "added1", "added2"])
        )
    ...
    def test_maintail_readlog_error_nofile(self):
        ...
        self.assertEqual(result, None)
        self.assertEqual(
            plugin.ctl.stdout.getvalue(), "supervisord: ERROR (no log file)\n"
        )
        self.assertEqual(plugin.ctl.exitstatus, LSBInitExitStatuses.GENERIC)
