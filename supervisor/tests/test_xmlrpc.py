...
class RPCErrorTests(unittest.TestCase):
    ...
    def test___str___shows_code_and_text(self):
        ...
        self.assertEqual(
            str(e), "code=%r, text='NO_FILE: /nonexistent'" % xmlrpc.Faults.NO_FILE
        )
...
class XMLRPCHandlerTests(unittest.TestCase):
    ...
    def test_continue_request_nosuchmethod(self):
        ...
        self.assertEqual(
            logdata[-2], "XML-RPC method called: supervisor.noSuchMethod()"
        )
        self.assertEqual(
            logdata[-1],
            (
    ...
    def test_continue_request_methodsuccess(self):
        ...
        self.assertEqual(len(logdata), 2)
        self.assertEqual(
            logdata[-2], "XML-RPC method called: supervisor.getAPIVersion()"
        )
        self.assertEqual(
            logdata[-1],
    ...
    def test_continue_request_500_if_xmlrpc_dumps_raises(self):
        ...
        self.assertEqual(
            logdata[0], "XML-RPC method called: supervisor.getXmlRpcUnmarshallable()"
        )
        self.assertEqual(
            logdata[1],
...
class TraverseTests(unittest.TestCase):
    ...
    def test_namespace_name_not_found(self):
        ...
        root = Root()
        self.assertRaises(
            xmlrpc.RPCError, xmlrpc.traverse, root, "notfound.hello", None
        )
    ...
    def test_method_name_exists_but_is_not_a_method(self):
        ...
        root.a.b = B()
        self.assertRaises(
            xmlrpc.RPCError, xmlrpc.traverse, root, "a.b", []
        )  # b is not a method
    ...
    def test_bad_params(self):
        ...
        root.a = A()
        self.assertRaises(
            xmlrpc.RPCError, xmlrpc.traverse, root, "a.hello", ["there", "extra"]
        )  # too many params
...
class SupervisorTransportTests(unittest.TestCase):
    ...
    def test_ctor_unknown(self):
        self.assertRaises(
            ValueError, self._makeOne, "user", "pass", "unknown:///foo/bar"
        )
    ...
    def test_request_non_200_response(self):
        ...
        self.assertRaises(
            xmlrpclib.ProtocolError, transport.request, "localhost", "/", ""
        )
    ...
    def test_request_400_response(self):
        ...
        self.assertEqual(
            dummy_conn.requestargs[3]["Authorization"], "Basic dXNlcjpwYXNz"
        )
...
class TestSystemNamespaceRPCInterface(unittest.TestCase):
            ...
            [
                {
                    ...
                    "faultString": (
                        "INCORRECT_PARAMETERS: Recursive " "system.multicall forbidden"
                    ),
                }
            ],
        )
    ...
    def test_multicall_faults_for_methodName_bad_namespace(self):
        ...
        self.assertEqual(
            results,
            [{"faultCode": Faults.UNKNOWN_METHOD, "faultString": "UNKNOWN_METHOD"}],
        )
    ...
    def test_multicall_performs_callback_functions_serially(self):
        ...
        calls = [
            ...
            {"methodName": "ns1.startProcess", "params": {"name": "foo"}},
        ]
        callback = inst.multicall(calls)
        results = NOT_DONE_YET
        while results is NOT_DONE_YET:
...
class Test_gettags(unittest.TestCase):
    ...
    def test_one_atpart(self):
        ...
        self.assertEqual(result, [(0, None, None, None, ""), (0, "foo", "", "", "")])

    def test_two_atparts(self):
        lines = "@foo array"
        result = self._callFUT(lines)
        self.assertEqual(
            result, [(0, None, None, None, ""), (0, "foo", "array", "", "")]
        )
    ...
    def test_three_atparts(self):
        ...
        result = self._callFUT(lines)
        self.assertEqual(
            result, [(0, None, None, None, ""), (0, "foo", "array", "name", "")]
        )
    ...
    def test_four_atparts(self):
        ...
        result = self._callFUT(lines)
        self.assertEqual(
            result, [(0, None, None, None, ""), (0, "foo", "array", "name", "text")]
        )
